	...
	assignment.config(['$stateProvider', function($stateProvider) {
		$stateProvider
			.state('base.app.courses.details.assignments', {
				...
				views: {
					'mainContent@base.app': {
						templateUrl: 'src/modules/facts/student/course/assignment/partials/assignments.tpl.html',
			...
			.state('base.app.courses.details.assignments.details', {
				...
				views: {
					'mainContent@base.app': {
						templateUrl: 'src/modules/facts/student/course/assignment/partials/details.tpl.html',
